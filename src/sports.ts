...
export const SPORTS: SportDef[] = [
  ...
  { key: "baseball", label: "Baseball", hasDraw: false, competitorKind: "team" },
  { key: "nfl", label: "Futbol amerykański (NFL)", hasDraw: false, competitorKind: "team" },
  { key: "rugby", label: "Rugby", hasDraw: true, competitorKind: "team" },
  { key: "afl", label: "AFL (futbol australijski)", hasDraw: false, competitorKind: "team" },
